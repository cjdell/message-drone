    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function sendCommand(cmd) {
                var url = '/control/' + cmd + '/' + Array.prototype.slice.call(arguments, 1).join('/');
            ...
            window.addEventListener('load', function() {
                ...
                submitButton.addEventListener('click', function() {
                    sendCommand('display', message.value);
                });
                ...
                video.src = 'http://' + window.location.hostname + ':8554';
            });
                    ...
                    for (var x = 0; x < 16; x++, i++) {
                        ...
                        (function(colour, x, y) {
                            cell.addEventListener('click', function() {
                                sendCommand('colour', colour.substring(1));
                            });
                        })(colour, x, y);
